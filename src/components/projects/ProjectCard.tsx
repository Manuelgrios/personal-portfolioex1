      ...
      >
        ...
        <div className={compact ? "pt-4" : "pt-5"}>
          ...
          <div className="mt-2 flex min-w-0 items-start justify-between gap-3">
            <h3 className={`${compact ? "text-lg" : "text-xl"} min-w-0 font-bold leading-snug text-text [overflow-wrap:anywhere]`}>
              {project.title}
            </h3>
            <ArrowRight
              aria-hidden="true"
          ...
          <p className={`${compact ? "mt-3 text-sm leading-6" : "mt-4 leading-7"} text-muted [overflow-wrap:anywhere]`}>
            {project.summary}
          </p>
